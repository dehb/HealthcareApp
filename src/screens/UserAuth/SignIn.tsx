...
import { FLEX, SIDES, COLORS } from "@styles/constants";
...
export default function SignIn({ navigation }: IComponent) {
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <TouchableOpacity
              onPress={() => navigation.navigate(FORGOT_PIN_SCREEN)}
            >
              <CustomText
